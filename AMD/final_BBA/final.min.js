...
// view.js
require([],function(){document.querySelector("form").addEventListener("submit",function(a){var b=this.querySelector("input[type=submit]");a.preventDefault(),b.classList.add("loading"),require(["modules/validation"],function(a){var c=document.querySelector("[name=cc_number]"),d=c.value;b.classList.remove("loading"),b=null,a.validate({ccNumber:d})?(c.classList.remove("error"),alert("Payed !")):c.classList.add("error")})})});
// modules/validation.js
define("modules/validation",["./MCCreditCardValidation"],function(a){return{validate:function(b){return b&&a.validate(b.ccNumber)}}});
// modules/MCCreditCardValidation.js
define("modules/MCCreditCardValidation",function(){var a=function(a){var b,c="";for(b=0;a.length>b;b++)a.charAt(b).match(/[0-9]/)&&(c=c.concat(a.charAt(b)));return c},b=function(b){var c="",d=0;b=a(b);for(var e=0;b.length>e;++e)c+=e%2?2*b.charAt(b.length-1-e):b.charAt(b.length-1-e);for(e=0;c.length>e;++e)d+=parseInt(c.charAt(e),10);return d%10?!1:!0};return{validate:function(a){return a&&a.match&&a.match(/^5[1-5].{14}$/)&&b(a)}}});